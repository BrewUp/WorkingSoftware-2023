using BrewUp.Modules.Purchases.Infrastructure.RabbitMq.Commands;
using BrewUp.Modules.Purchases.Infrastructure.RabbitMq.Events;
...
namespace BrewUp.Modules.Purchases.Infrastructure.RabbitMq;
